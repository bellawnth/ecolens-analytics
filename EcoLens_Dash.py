...
.kpi-val {
  font-family:'Space Grotesk', sans-serif !important;
  font-size:2.2rem; font-weight:700; color:var(--g1) !important;
  line-height:1.05; margin:.2rem 0 .1rem; word-break:break-word;
}
...
with st.sidebar:
    ...
    st.caption("EcoLens estimates CO₂ footprint from food. 290 items · 20 categories · kg CO₂e/kg food.")
    st.markdown("---")
...
<div class="hero">
  ...
  <p>Food Carbon Footprint Dashboard · 290 items · 20 categories · kg CO₂e per kg food</p>
</div>
""", unsafe_allow_html=True)
...
kpi_defs = [
    ...
    ("Avg CO₂",          f"{df['emisi'].mean():.2f}",   "kg CO₂e / kg food",                     "amber"),
    ("Median CO₂",       f"{df['emisi'].median():.2f}", "kg CO₂e / kg food",                     "teal"),
...
with r1a:
    ...
    fig_bar = go.Figure(go.Bar(
        ...
        hovertemplate="<b>%{y}</b><br>Avg CO₂: <b>%{x:.3f}</b> kg CO₂e/kg<extra></extra>",
    ))
    fig_bar.update_layout(**COMMON,
        hoverlabel=HOVER_STYLE,
        height=580,
        margin=dict(l=10, r=80, t=10, b=10),
        xaxis_title="kg CO₂e per kg food",
        yaxis_title="",
...
with r1b:
    ...
    <div class="insight red">
      ...
      <div class="insight-body">Rata-rata <b>24.2 kg CO₂e/kg</b> — 30× lebih tinggi dari buah.
      Beef mencapai <b>99.5 kg CO₂e/kg</b>, tertinggi di dataset.</div>
    </div>
    <div class="insight">
      <div class="insight-title" style="color:{G1}">🥦 Tanaman Jauh Lebih Ramah</div>
      <div class="insight-body">Buah & Sayur rata-rata di bawah <b>0.8 kg CO₂e/kg</b>.
      Ganti satu meal daging/minggu ke legumes hemat ~100 kg CO₂e/bulan.</div>
    </div>
    """, unsafe_allow_html=True)
...
insights_data = [
    ("🥩 Meat & Poultry", "red",   CORAL,
     "Sapi dan domba menghasilkan metana dari fermentasi usus. Konversi lahan untuk padang penggembalaan juga melepas karbon. Beef bisa capai <b>99.5 kg CO₂e/kg</b>."),
    ("🐟 Fish & Seafood",  "amber", AMBER,
     "Trawling sangat boros bahan bakar. Budidaya udang sering butuh pembukaan mangrove. Sarden & kerang jauh lebih rendah emisinya."),
    ("🧀 Dairy Products",  "teal",  TEAL,
     "Sapi perah menghasilkan metana dan butuh pakan dari pupuk sintetis. Beralih ke susu oat/kedelai mengurangi emisi 60–80% per liter."),
    ("🥦 Fruits & Veg",    "",      G1,
     "Tanaman menyerap karbon dan butuh jauh lebih sedikit lahan. Pilihan lokal & musiman memperkecil emisi transportasi. Buah rata-rata <b>0.47 kg CO₂e/kg</b>."),
]
